...
try:#delete spec thing
    os.remove(vl+"\\Lib\\site-packages\\VIS\\VIS\\VIS.spec")
except: 
    print("Couldn't delete "+vl+"\\Lib\\site-packages\\VIS\\VIS\\VIS.spec")

try:#delete build
    shutil.rmtree(vl+"\\Lib\\site-packages\\VIS\\VIS\\build")
except: 
    print("Couldn't delete "+vl+"\\Lib\\site-packages\\VIS\\VIS\\build")
...
try:#move VIS.exe  
    shutil.copyfile(vl+"\\Lib\\site-packages\\VIS\\VIS\\dist\\VIS.exe",vl+"\\Scripts\\VIS.exe")
except: 
